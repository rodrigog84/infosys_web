...
class ConsumoFolio extends \sasco\LibreDTE\Sii\Base\Libro
{
    ...
    private function getResumen()
    {
        ...
        foreach ($this->detalles as &$d) {
            ...
            $Resumen[$d['TpoDoc']]['MntTotal'] += (int)$d['MntTotal']*1.19;
        ...
        print_r($Resumen); 
         ...
         $Resumen['39']['MntTotal'] = floor( $Resumen['39']['MntTotal']);
         $Resumen['39']['MntNeto'] = floor( $Resumen['39']['MntTotal']/1.19);
         $Resumen['39']['MntIva'] =  $Resumen['39']['MntTotal'] - $Resumen[39]['MntNeto'];
