...
class EnvioBoleta
{
   ...
   // protected static $URLEnvio;
    private $URL = "https://api.sii.cl/recursos/v1";
   ...
   // public static function enviar($usuario, $empresa, $xml, $Firma, $gzip = false, $retry = null)
     public static function enviar($usuario, $empresa, $xml, $token, $gzip = false, $retry = null)
    {
       // self::setserver();
        ///OBTENCION DEL TOKEN
    ...
    {         
       ...
       // echo $URL."/boleta.electronica.semilla<br>";
       // echo "https://api.sii.cl/recursos/v1/boleta.electronica.semilla";
...
/**
    ...
    public static function consultaBoleta($rut, $dv, $track_id, $Firma, $dte, $folio,$token,$rut_receptor,$dv_receptor,$monto_dte,$fecha_envio,$retry=1)
    {
        $curl = curl_init();
       /* $header = [
