Ext.define('Infosys_web.controller.Cotizacion', {
    ...
    agregarItem3: function() {
        ...
        var nueneto = parseInt(nueneto + neto);
        var nueiva = parseInt(nueiva + iva);
        var nuetotal = parseInt(nuetotal + total);
        var nuedesc = parseInt(nuedesc + desc);
        var nueafecto = parseInt(nueneto + nuedesc);
    ...
    agregarItem2: function() {
        ...
        var tot = (parseInt((cantidad * precio) - descuento));
        total = (tot);
        iva = (parseInt((tot * 19)/100));
        neto  = parseInt(total - iva);  
    ...
    recalcularFinal2: function(){
        ...
        stItem.each(function(r){
            pretotal = parseInt(pretotal + r.data.total)
        });
