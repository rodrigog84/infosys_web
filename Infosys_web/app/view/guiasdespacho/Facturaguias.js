                    ...
                    items: [
                    {
...

                        {
                            ...
                            columns: [
                                    ...
                                    { text: 'Neto',  dataIndex: 'neto',  align: 'right', width: 250, renderer: function(valor){return Ext.util.Format.number(parseInt(valor),"0,000")} },
                                    { text: 'Iva',  dataIndex: 'iva',  align: 'right', width: 250, renderer: function(valor){return Ext.util.Format.number(parseInt(valor),"0,000")} },
                                    { text: 'Total',  dataIndex: 'total',  align: 'right', width: 250, renderer: function(valor){return Ext.util.Format.number(parseInt(valor),"0,000")} }
                                ]
                            },{
                        xtype: 'fieldset',
