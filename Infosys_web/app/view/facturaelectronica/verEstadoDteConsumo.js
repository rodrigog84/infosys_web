Ext.define('Infosys_web.view.facturaelectronica.verEstadoDteConsumo' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.verestadodteconsumo',
    ...
    initComponent: function() {
        me = this;
        var idconsumo = me.idconsumo;
        estado_envio_dte = "";
        estado_dte = "";

        response_datos = Ext.Ajax.request({
        async: false,
        url: preurl + 'facturas/datos_dte_json_consumo/'+idconsumo});
        ...
        if(obj_datos.length == 0){
            ...
            var tipo_doc = 'Consumo de Folios';
            var folio = '-';
        ...
        if(trackid == ""){
            ...
            async: false,
            url: preurl + 'facturas/estado_envio_consumo_folios/'+idconsumo});
        ...
        /*if(trackid == ""){
         ...
         /*   response_estado = Ext.Ajax.request({
            ...
            url: preurl + 'facturas/estado_dte_consumo_folios/'+idconsumo});
