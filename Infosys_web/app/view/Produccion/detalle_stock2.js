Ext.define('Infosys_web.view.Produccion.detalle_stock2' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.detallestock5',
    
    requires: ['Ext.toolbar.Paging'],
    title : 'Detalle Existencias Guias Directas ',
    layout: 'fit',
    autoShow: true,
    width: 880,
    height: 480,
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            items: [
           {
            ...
            xtype: 'button',
            margin: 5,
            action: 'seleccionarproductosstock5',
            dock: 'bottom',
            text : 'Seleccionar'
        },
        {
