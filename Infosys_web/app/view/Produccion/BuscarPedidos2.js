Ext.define('Infosys_web.view.Produccion.BuscarPedidos2' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.buscarpedidosproduccion2',
    
    requires: ['Ext.toolbar.Paging'],
    title : 'Pedidos Produccion Por Formulas',
    layout: 'fit',
    autoShow: true,
    width: 1080,
    height: 480,
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            xtype: 'button',
            margin: 5,
            action: 'seleccionarpedidoproduccion2',
            dock: 'bottom',
            text : 'Seleccionar'
        },
        {
